                ...
                <div class="col-lg-6 col-md-5">
                    <div class="header__top__right">
                        ...
                        <div class="header__top__hover">
                            <span>LE <i class="arrow_carrot-down"></i></span>
                            <ul>
                                <li>LE</li>
                                <li>EUR</li>
                                <li>USD</li>
            ...
            <div class="col-lg-3 col-md-3">
                <div class="header__logo">
                    <div class="logo d-flex">
                        <img src="{{asset('frontend/img/logo.png')}}" alt="kokoshop" width="50" height="50"/>
                      </div>
            ...
            <div class="col-lg-6 col-md-6">
                <nav class="header__menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="{{route('frontend.shop')}}">Pages</a>
                            <ul class="dropdown">
                                <li><a href="{{route('frontend.about')}}">About Us</a></li>
                                <li><a href="{{route('frontend.shopdetails')}}">Shop Details</a></li>
                                <li><a href="{{route('frontend.shoppingCart')}}">Shopping Cart</a></li>
                                <li><a href="{{route('frontend.checkOut')}}">Check Out</a></li>
                                <li><a href="{{route('frontend.blogDetails')}}">Blog Details</a></li>
                            </ul>
                        </li>
