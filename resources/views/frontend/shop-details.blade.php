                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="{{ asset('frontend/img/shop-details/thumb-1.png') }}"></div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="{{ asset('frontend/img/shop-details/thumb-2.png') }}"></div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="{{ asset('frontend/img/shop-details/thumb-3.png') }}"></div>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                    <div class="product__details__tab__content">
                                        ...
                                        <div class="product__details__tab__content__item">
                                            ...
                                            <p>Materia: 80% cotton, 20% polyester</p>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <h5>Washcare</h5>
                                            <p>Please keep it in the ventilated and dry place and keep away from the
                                                petroleum</p>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <h5>Jacket Measurements</h5>
                                            <p>Materia: 80% cotton, 20% polyester</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tabs-6" role="tabpanel">
                                    <div class="product__details__tab__content">
                                        ...
                                        <div class="product__details__tab__content__item">
                                            <h5>Lucas de Jongh</h5>
                                            <span>12 Dec 2023</span>
                                            <p>Amazing hooded thermal anorak, really loved it!</p>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <h5>Jenny Jager</h5>
                                            <span>05 Jan 2023</span>
                                            <p>Great product, comfortable and stylish!</p>
                                        </div>
                                    </div>
                                </div>
