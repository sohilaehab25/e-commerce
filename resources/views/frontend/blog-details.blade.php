            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-12">
                    <div class="blog__details__pic">
                        <img src="{{ asset('frontend/img/blog/details/blog-details.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="blog__details__content">
                        <div class="blog__details__share">
                            <span>share</span>
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook m-2"></i></a></li>
                                <li><a href="#" class="twitter"><i class="fa fa-twitter m-2"></i></a></li>
                                <li><a href="#" class="youtube"><i class="fa fa-youtube-play m-2"></i></a></li>
                                <li><a href="#" class="linkedin"><i class="fa fa-linkedin m-2"></i></a></li>
                            </ul>
                        </div>
